...
for i in range(5):
        ...
        # read the instantaneous time
        right_this_hour = datetime.today().hour
        right_this_minute = datetime.today().minute
        right_this_second = datetime.today().second

        right_this_hourSTR = str(right_this_hour)
        right_this_minuteSTR = str(right_this_minute)
        right_this_secondSTR = str(right_this_second)
        print('Current time stamp: '+ right_this_hourSTR + ":" + right_this_minuteSTR + ":" + right_this_secondSTR)
        time.sleep(randTime)
        print("")